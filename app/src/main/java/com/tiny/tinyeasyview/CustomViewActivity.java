...
/**
 * Created by ${Tiny} on 2015/12/13.
 */
public class CustomViewActivity extends AppCompatActivity  implements CustomView.VelocityValueChangeListener, View.OnTouchListener{
